 ...
 * @defgroup bt_amota Throughput Service (AMOTA)
 * @ingroup bluetooth
 * @{
 *
...
/** @brief 32-byte Metadata added ahead of the actual image and behind of 48-byte AMOTA header */
typedef struct
{
    /* Word 0 */
...
#define BT_UUID_AMOTA_SVC_VAL                                                                 \
	BT_UUID_128_ENCODE(0x00002760, 0x08C2, 0x11E1, 0x9073, 0x0E8AC72E1001)
