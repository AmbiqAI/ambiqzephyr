...
typedef struct {
	uint8_t writeBuffer[AMOTA_WRITE_PAGE_SIZE] __attribute__((aligned(4)));
...
/* CRC-32 stable for OTA data CRC calculation */
...
{
	amota_notify_ch = bt_gatt_find_by_uuid(amota_svc.attrs, 0, BT_UUID_AMOTA_TX_CHAR);
